...
| AI progression and temporal coverage | `node --test examples/chinese-chess/ai.test.mjs` | suggestion has a move, a move id, and no repeat | 3/3 passing | pass |
| Browser accepts suggestion | `node --test examples/chinese-chess/browser.test.mjs` | board has 90 cells and turn changes to Black | 2/2 passing | pass |
